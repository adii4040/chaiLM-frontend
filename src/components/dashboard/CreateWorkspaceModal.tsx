      ...
      <div className="bg-chailm-panel border border-chailm-border rounded-3xl max-w-md w-full p-6 space-y-5 shadow-2xl relative overflow-hidden">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 text-xs">
          ...
          <p className="text-[11px] text-chailm-textMuted leading-relaxed">
            Creating a new workspace generates an isolated grounding context session. You can index YouTube videos, PDF documents, and websites inside.
          </p>
          ...
          <div className="pt-2 flex justify-end space-x-2">
            ...
            <button
              type="submit"
              disabled={isSubmitting}
              className="px-5 py-2 bg-chailm-accentBlue/10 hover:bg-chailm-accentBlue/20 text-chailm-accentBlue font-medium rounded-full text-xs border border-chailm-accentBlue/30 transition-all cursor-pointer flex items-center space-x-1.5 disabled:opacity-50"
            >
              {isSubmitting ? (
                <>
